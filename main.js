...
let directionsClose = document.querySelector(".directions-close");
...
let directionsModalBg = document.querySelector(".directions-modal-bg");
...
let directionsBtn = document.querySelector("#directions-demo-btn");
...
directionsBtn.addEventListener("click", () => {
  directionsModalBg.classList.add("directions-active");
});
directionsClose.addEventListener("click", () => {
  directionsModalBg.classList.remove("directions-active");
});
